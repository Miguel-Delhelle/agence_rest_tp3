 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://web.service.hotel/", wsdlLocation = "http://localhost:8888/hotel?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://web.service.hotel/", "HotelService");
    ...
    public IHotelService getHotelPort() {
        return super.getPort(new QName("http://web.service.hotel/", "HotelPort"), IHotelService.class);
    }
    ...
    public IHotelService getHotelPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web.service.hotel/", "HotelPort"), IHotelService.class, features);
    }
