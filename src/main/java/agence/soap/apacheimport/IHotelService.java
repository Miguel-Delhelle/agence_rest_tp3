...
;
    ...
    @WebMethod
    @Action(input = "http://web.service.hotel/IHotelService/getListeChambreRequest", output = "http://web.service.hotel/IHotelService/getListeChambreResponse")
    @RequestWrapper(localName = "getListeChambre", targetNamespace = "http://web.service.hotel/", className = "agence.soap.apacheimport.GetListeChambre")
    @ResponseWrapper(localName = "getListeChambreResponse", targetNamespace = "http://web.service.hotel/", className = "agence.soap.apacheimport.GetListeChambreResponse")
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<agence.soap.apacheimport.Chambre> getListeChambre()
;
